...
namespace Tollbound
{
    ...
    public class TollboundPlugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            // prefabs exist. Items likewise are not in the ObjectDB at plugin load, which is
            // why the cargo registry and the survey both wait for their own event.
        ...
        private static void OnItemsRegistered()
        {
            ...
            {
                Diagnostics.ItemReport.Run();
            }
        }

        private void BindConfig()
        {
            TollboundConfig.Bind(Config);
        }
